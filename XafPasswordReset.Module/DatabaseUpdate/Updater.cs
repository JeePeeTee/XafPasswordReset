...
namespace XafPasswordReset.Module.DatabaseUpdate;
...
#if !RELEASE
        if (TenantName == null) {
            _ = CreateTenant("company1.com", "XafPasswordReset_company1");
            _ = CreateTenant("company2.com", "XafPasswordReset_company2");
