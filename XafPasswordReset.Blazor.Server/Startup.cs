...
using XafPasswordReset.Blazor.Server.Services;
...
using XafPasswordReset.WebApi.JWT;
using DevExpress.ExpressApp.Security.Authentication;
using DevExpress.ExpressApp.Security.Authentication.ClientServer;
using DevExpress.ExpressApp.MultiTenancy;
using Microsoft.Extensions.DependencyInjection;

namespace XafPasswordReset.Blazor.Server;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddXaf(Configuration, builder => {
            builder.UseApplication<XafPasswordResetBlazorApplication>();
            ...
            builder.Modules
                ...
                .Add<XafPasswordReset.Module.XafPasswordResetModule>()
            	.Add<XafPasswordResetBlazorModule>();
            ...
            builder.Security
                .UseIntegratedMode(options => {
                    ...
                    options.UserType = typeof(XafPasswordReset.Module.BusinessObjects.ApplicationUser);
                    // ApplicationUserLoginInfo is only necessary for applications that use the ApplicationUser user type.
                    // If you use PermissionPolicyUser or a custom user type, comment out the following line:
                    options.UserLoginInfoType = typeof(XafPasswordReset.Module.BusinessObjects.ApplicationUserLoginInfo);
        ...
        services.AddSwaggerGen(c => {
            ...
            c.SwaggerDoc("v1", new OpenApiInfo {
                Title = "XafPasswordReset API",
                Version = "v1",
                Description = @"Use AddXafWebApi(options) in the XafPasswordReset.Blazor.Server\Startup.cs file to make Business Objects available in the Web API."
            });
    ...
    public void Configure(IApplicationBuilder app, IWebHostEnvironment env) {
        if(env.IsDevelopment()) {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => {
                c.SwaggerEndpoint("/swagger/v1/swagger.json", "XafPasswordReset WebApi v1");
            });
        }
        else {
